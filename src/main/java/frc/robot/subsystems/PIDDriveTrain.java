...
public class PIDDriveTrain extends SubsystemBase {
  ...
  private final DifferentialDriveKinematics driveKinematics =
      new DifferentialDriveKinematics(distanceBetweenWheels);
  ...
  private void setSpeeds(DifferentialDriveWheelSpeeds speeds) {
    ...
    final double leftOutput =
        leftPID.calculate(leftEncoder.getVelocity(), speeds.leftMetersPerSecond);
    final double rightOutput =
        rightPID.calculate(rightEncoder.getVelocity(), speeds.rightMetersPerSecond);
